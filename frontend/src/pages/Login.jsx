...
function Login() {
  ...
  const styles = {
    ...
    submitBtn: {
      ...
      background: loading
        ? "#3A1414"
        : `linear-gradient(135deg, ${RED} 0%, #A00808 100%)`,
  ...
  return (
    <div style={styles.page}>
      <style>{`
        ...
        .cc-login-input:focus-visible { outline: none; }

        .cc-login-submit:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 6px 22px rgba(235,27,35,0.45) !important; background: linear-gradient(135deg, ${RED_BRIGHT} 0%, #B30909 100%) !important; }
        .cc-login-submit:active:not(:disabled) { transform: scale(0.98); }
        .cc-login-submit:focus-visible { outline: 2px solid ${RED_BRIGHT}; outline-offset: 2px; }
        .cc-login-link:hover { color: ${RED_BRIGHT} !important; text-decoration: underline; }
        .cc-login-toggle:hover { color: #F5F5F5 !important; }
      `}</style>

      <ParticleBackground />

      <div className="cc-login-card" style={styles.card}>
        <div style={styles.logoRow}>
          <span style={styles.logoDot} />
          <div style={styles.logo}>AI Career Coach</div>
        </div>
        <div style={styles.subtitle}>Log in to keep building your path</div>
        ...
        <p style={styles.footer}>
          No account?{" "}
          <a href="/signup" className="cc-login-link" style={styles.link}>
            Sign up
          </a>
        </p>
      </div>
